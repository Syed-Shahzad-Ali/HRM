...
class ManagerViews(ModelViewSet):
    ...
    def get_manager(self,request):
        return rank_controller.get_manager(request)
    def update_manager(self,request):
        return rank_controller.update_manager(request)
...
class EmployeeViews(ModelViewSet):
    ...
    def get_employee(self,request):
        return rank_controller.get_employee(request)
    def update_employee(self,request):
        return rank_controller.update_employee(request)
    def delete_employee(self,request):
        return rank_controller.delete_employee(request)
